    ...
    <el-row class="table-people-info">
     ...
     >
      <template slot-scope="scope">
        <el-button type="text" size="small"  @click="remarks(scope.row.id)">备注</el-button>
...
export default {
  ...
  methods: {
    remarks (row) {
      ...
      this.$http.post('/admin/userRemarks',{id:row,cont:this.remarks_text}).then((res)=>{
          ...
          // this.$store.commit('update_remarks_list',res.data.data)
